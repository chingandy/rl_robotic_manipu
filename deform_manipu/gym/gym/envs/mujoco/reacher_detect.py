...
class ReacherEnvDetect(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def _get_obs(self):
        ...
        # print("-" * 50 )
        # print("Target position: ", type(self.sim.data.qpos.flat[2:]))
        ...
        # print("fingertip:    ",self.get_body_com("fingertip").shape)
        # print("target:      ",self.get_body_com("target"))
        # print("target pos:  ", self.sim.data.qpos.flat[2:])
        # print("detector :  ", estimated_target_pos)
